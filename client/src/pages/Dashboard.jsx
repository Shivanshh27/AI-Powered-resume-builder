import { FilePenLineIcon, PencilIcon, PlusIcon, TrashIcon, Upload } from "lucide-react";
  ...
  return (
    <div>
      <div className="max-w-7xl mx-auto px-4 py-8">
        <p className=" text-2xl font-medium mb-6 bg-gradient-to-4 from-slate-600 to slate-700 bg-clip-text text-transparent sm:hidden">
          Welcome Back
        </p>
          ...
          {allResumes.map((resume, index)=>{
            ...
            return (
              <button
                ...
                style={{
                  background: `linear-gradient(140deg, ${baseColor}10, ${baseColor}40)`, borderColor: baseColor + '40'
                }}
              >
