          ...
          {allResumes.map((resume, index) => {
            ...
            return (
              <button
                ...
                style={{
                  background: `linear-gradient(140deg, ${baseColor}10, ${baseColor}40)`,
            ...
            >
              ...
              >
                ...
                <input
                  ...
                  required
                />
                <button className="w-full py-2 bg-green-600 text-white rounded gover:bg-green-700 transition-colors">
                  Create Resume
                </button>
                <XIcon
